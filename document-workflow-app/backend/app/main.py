...
from app.modules.cash_flow.bdds_report_router import router as cash_flow_bdds_report_router
...
fastapi_app.include_router(cash_flow_bdds_report_router, prefix=settings.api_v1_prefix)
